...
save_folder= '/home/altaf/Everyday_tasks/face_rec/Face-Recognition-System/final_img/'
...
def tracking(detector, args):
    ...
    cap = cv2.VideoCapture('rtsp://dl-team:dl@Onstak123@10.39.110.246:554/ch3/main/av_stream.h264')
    ...
    while True:
        ...
        if frame_count >= 30:
            ...
            frame_count = 0
            start_time = time.time_ns()
        tracking_image= cv2.resize(tracking_image,(1000,800))
            ...
            for j in range(len(detection_bboxes)):
                ...
                if mapping_score > 0.9:
                    ...
                    if name is not None:
                        ...
                        filename = f"{name}_{tracking_ids[i]}_{counter} .jpg"
                        save_path = os.path.join(save_folder, filename)
                        cv2.imwrite(save_path, face_alignment)
                        counter +=1
